...
export const DateComponent:React.FC<DateComponentProps> = (props:DateComponentProps) => {
  return (
    <div className="date-component-container">{props.date.toLocaleDateString(undefined, {
